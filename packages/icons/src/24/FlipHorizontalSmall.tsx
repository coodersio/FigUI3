/**
 * FlipHorizontalSmall Icon (24px)
 *
 * @example
 * ```tsx
 * import { FlipHorizontalSmall } from '@figui3/icons/24';
 *
 * <FlipHorizontalSmall />
 * ```
 */
...
export const FlipHorizontalSmall = createIcon({
  path: (
    <>
    <path
  ...
  displayName: 'FlipHorizontalSmall',
  defaultSize: 24,
});
