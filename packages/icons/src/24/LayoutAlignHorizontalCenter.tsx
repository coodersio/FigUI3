/**
 * LayoutAlignHorizontalCenter Icon (24px)
 *
 * @example
 * ```tsx
 * import { LayoutAlignHorizontalCenter } from '@figui3/icons/24';
 *
...
export const LayoutAlignHorizontalCenter = createIcon({
  path: (
    <>
    <path
  ...
  displayName: 'LayoutAlignHorizontalCenter',
  defaultSize: 24,
});
