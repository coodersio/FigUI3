/**
 * AlPaddingHorizontal Icon (24px)
 *
 * @example
 * ```tsx
 * import { AlPaddingHorizontal } from '@figui3/icons/24';
 *
 * <AlPaddingHorizontal />
 * ```
 */
...
export const AlPaddingHorizontal = createIcon({
  path: (
    <>
    <path
  ...
  displayName: 'AlPaddingHorizontal',
  defaultSize: 24,
});
