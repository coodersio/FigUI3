/**
 * LayoutAlignVerticalCenter Icon (24px)
 *
 * @example
 * ```tsx
 * import { LayoutAlignVerticalCenter } from '@figui3/icons/24';
 *
...
export const LayoutAlignVerticalCenter = createIcon({
  path: (
    <>
    <path
  ...
  displayName: 'LayoutAlignVerticalCenter',
  defaultSize: 24,
});
